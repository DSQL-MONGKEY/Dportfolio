   ...
   return (
      <section className="space-y-4 bg-cover bg-no-repeat">
            ...
            <div className="space-y-4">
               ...
               <p className="leading-loose text-neutral-900 font-outfit dark:text-white">
                  Software Engineer driven by a passion for building modern user-focused applications that blend intuitive design with robust functionality. With expertise in JavaScript/TypeScript, I combine creativity with technical precision to deliver scalable, efficient, and highly maintainable applications. 
               </p>
            </div>
      </section>
   )
